 ...
 *
 *   WP_URL=https://example.com MONTANA_PATHS=/,/contact/ node .dev/overflow-check.mjs
 *
 * @package Montana
 */
...
const paths = ( process.env.MONTANA_PATHS || '/,/rooms/,/about/,/contact/,/blog/,/five-walks-from-the-front-door/,/category/outdoors/,/?s=lake,/no-such-page/' ).split( ',' ).filter( Boolean );
const widths = ( process.env.MONTANA_WIDTHS || '1400,1024,768,390' ).split( ',' ).map( Number );
